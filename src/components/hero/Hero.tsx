...
export const Hero = () => {
    return (
       <div id="site-hero" className="p-0 m-0 text-center d-flex flex-column justify-content-center align-items-center text-white fw-bold about-section border border-black border-3">
