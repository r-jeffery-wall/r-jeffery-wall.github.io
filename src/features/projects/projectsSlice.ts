...
const initialState: ProjectsState = {
  projectsList: [
    // Dummy data.
    {
      ...
      image: {
        path: '../images/ReadOnlyReddit.png',
    ...
    },
    {
      ...
      image: {
        path: '../images/2023-12-10_17-19.png',
    ...
    },
    {
      ...
      image: {
        path: '../images/mismatched_quotes.png',
        alt:
    ...
    },
    {
      ...
      image: {
        path: '../images/Screenshot from 2024-02-21 20-14-22.png',
        alt:
    ...
    },
    {
      ...
      image: {
        path: '../images/Screenshot from 2024-02-21 20-19-48.png',
    ...
    },
    {
      ...
      image: {
        path: '../images/Screenshot from 2024-03-23 11-57-01.png',
        alt: 'A screenshot showing the flashcard web-app.',
      },
      skills: ['JavaScript', 'React', 'Redux', 'Git', 'GitHub'],
    },
    {
      name: 'BMI Calculator',
      ...
      image: {
        path: '../images/Screenshot from 2024-04-01 17-31-05.png',
        alt: 'A screenshot showing the BMI Calculator app.',
      },
      skills: ['JavaScript', 'React', 'CSS', 'Git', 'GitHub'],
    },
  ],
  filterList: [],
}
